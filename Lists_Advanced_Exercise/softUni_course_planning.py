def add_lesson_title(lesson: list, command: list) -> list:
    # Add lesson to the end of the list if it doesn't exist
    title = command[1]
...
def insert_lesson_title(lesson: list, command: list) -> list:
    # Insert lesson at a specific index if it doesn't exist
...
def remove_lesson_title(lesson: list, command: list) -> list:
    # Remove lesson and its associated exercise
    title = command[1]
...
def swap_lesson_title(lesson: list, command: list) -> list:
    # Swap two lessons and maintain the correct positions of their exercises
    title_one = command[1]
    title_two = command[2]
    ...
    if title_one in lesson and title_two in lesson:
        ...
        # Re-position exercises after the swap
...
def exercise_lesson_title(lesson: list, command: list) -> list:
    # Add an exercise for a lesson, creating the lesson if it doesn't exist
    title = command[1]
