def positive_numbers(numbers: list) -> list:
    # Filter and return only positive numbers (including zero)
    return [data for data in numbers if data >= 0]


def negative_numbers(numbers: list) -> list:
    # Filter and return only negative numbers
    return [data for data in numbers if data < 0]
...
# Get filtered results using the functions
...
# Print the results formatted as comma-separated strings
