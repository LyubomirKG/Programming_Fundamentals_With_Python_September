...
def calculate_line(first: list, second: list) -> float:
    """Calculates the length of the line between two points (x, y) in the coordinate system"""
...
def cartesian_coordinate_system(first_points: list, second_points: list) -> list:
    """Compares two points and returns the one closer to the center (0,0)"""
...
# Reading four points (x, y) from the input
...
# Compare lines and determine which point to print first (the one closer to the center)
if line_one >= line_two:
    point_one_or_two = cartesian_coordinate_system(first_point, second_point)
    point_one = first_point if point_one_or_two == [floor(d) for d in first_point] else second_point
    point_two = second_point if point_one_or_two == [floor(d) for d in first_point] else first_point
else:
    point_one_or_two = cartesian_coordinate_system(third_point, fourth_point)
    point_one = third_point if point_one_or_two == [floor(d) for d in third_point] else fourth_point
    point_two = fourth_point if point_one_or_two == [floor(d) for d in third_point] else third_point

# Format points as integers after applying floor
